              ...
              children: [
                ...
                Center(
                  child: Column(
                    ...
                    children: [
                      Text('${vmSelectedValue.currentPage + 6} / 6'),
                      Padding(
                      ...
                      ElevatedButton(
                          onPressed: () async {
                            box.write(
                                'highBp', vmSelectedValue.highBpradioValue);
                            dangjinRConnect.alcohol =
                                box.read('alcohol').toString();
                            dangjinRConnect.fruit =
                                box.read('fruit').toString();
                            dangjinRConnect.genHlth =
                                box.read('genHlth').toString();
                            dangjinRConnect.heart =
                                box.read('heart').toString();
                            dangjinRConnect.highBp =
                                box.read('highBp').toString();
